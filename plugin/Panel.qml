...
Panel {
  ...
  KeyboardPanel {
    ...
    // the whole point is reading limits and history without scrolling. No cap
    // beyond the screen — the panel grows with the column until it reaches
    // the bottom margin, and only then does the flickable scroll.
